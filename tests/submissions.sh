...
gcloud builds submit . --config cloudbuild.yaml --substitutions "_SERVICE_NAME="hello",_REPLY_TOPIC=\"projects/cloud-build-pipeline-396819/topics/$topicName\",_TAG_TO_DEPLOY="0.0.1-SNAPSHOT-4434da0f",_ENV="dev",_SERVICE_ACCOUNT="cloud-run@cloud-build-pipeline-396819.iam.gserviceaccount.com",_PROJECT_TYPE="java21"" --region=us-central1
